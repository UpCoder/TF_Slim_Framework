...
def _process_image(dataset_dir, case_name):
...
def _add_to_tfrecord(dataset_dir, case_name, tfrecord_writer):
    ...
    image_data, mask_data = _process_image(dataset_dir, case_name)
    ...
    while i < len(case_names):
        ...
        with tf.python_io.TFRecordWriter(tf_filename) as tfrecord_writer:
            ...
            while i < len(case_names) and j < SAMPLES_PER_FILES:
                ...
                _add_to_tfrecord(dataset_dir, case_name, tfrecord_writer)
                i += 1
                j += 1
            fidx += 1
...
if __name__ == '__main__':
    ...
    output_dir = '/home/give/Documents/dataset/data-science-bowl-2018/stage1_train_tfrecords'
    # preprocessing_dir(dataset_dir)
    run(dataset_dir, output_dir, name='DSB2018')
